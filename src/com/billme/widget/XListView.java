...
public class XListView extends ExpandableListView implements OnScrollListener {
	...
	public interface PinnedHeaderAdapter {
		 ...
		 */
		int getPinnedHeaderState(long position,long nextPosition);
		 ...
		 */
		void configurePinnedHeader(View header, long position, int alpha);
	}
	...
	public void configureHeaderView(int position) {
		...
		int state = nAdapter
				.getPinnedHeaderState(getExpandableListPosition(position),getExpandableListPosition(position+1));
		switch (state) {
		...
		case PinnedHeaderAdapter.PINNED_HEADER_VISIBLE: {
			nAdapter.configurePinnedHeader(nHeaderView,
					getExpandableListPosition(position), MAX_ALPHA);
		...
		case PinnedHeaderAdapter.PINNED_HEADER_PUSHED_UP: {
			...
			nAdapter.configurePinnedHeader(nHeaderView,
					getExpandableListPosition(position), 0);
